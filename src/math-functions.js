...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const product = multiply(multi[0], c);

    return [finalSum[0], product[0], `${a} and ${b} and ${c} sum to ${finalSum[0]}.`, `The product of ${a} and ${b} and ${c} is ${product[0]}.`];
}
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. 
// Don't forget to create a new branch for your work on the next question!
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    return [bob[0], `${a},${b},${c} was passed in as an array of numbers, and ${bob[0]} is their sum.`];
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const b = multArr[1];
    const c = multArr[2];
    const hi = multiply(a, b);
    const hiAgain = multiply(hi[0], c);
    return [hiAgain[0], `The numbers ${a},${b},${c} have a product of ${hiAgain[0]}.`];
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    const Who = multiply(a, b);
    const Who2 = multiply(Who[0], c);
    const Who3 = multiply(Who2[0], d);
    const Who4 = multiply(Who3[0], e);

    return [Who4[0], `The numbers ${a},${b},${c},${d},${e} have a product of ${Who4[0]}.`];
}
